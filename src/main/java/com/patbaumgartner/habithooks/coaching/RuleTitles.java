...
public final class RuleTitles {
    ...
    private static final List<RuleTitle> TITLE_DATA = List.of(
            ...
            new RuleTitle("openrewrite:SuggestedRefactor", "Suggested Automated Refactor"),
            new RuleTitle("openrewrite:goal-failed", "OpenRewrite Goal Failed"),
            new RuleTitle("openrewrite:lifecycle-blocked", "OpenRewrite Lifecycle Blocked"),
            new RuleTitle("openrewrite:report-missing", "OpenRewrite Patch Missing"),
            new RuleTitle("openrewrite:report-unreadable", "OpenRewrite Patch Unreadable"),
