...
/**
 * Per-rule configuration override. All fields are optional; unset fields fall back to the
 * tool's own defaults.
 */
public class RuleConfig {
    ...
    /**
     * Ant-style glob patterns for files to include in this rule's scope. When empty, all
     * files in the analysis scope are included.
     */
    ...
    public void setInclude(String[] include) {
        this.include = include == null ? new String[0] : include.clone();
    }
    ...
    public void setExclude(String[] exclude) {
        this.exclude = exclude == null ? new String[0] : exclude.clone();
    }
    ...
    public void setSeverity(String severity) {
        this.severity = severity == null || severity.isBlank() ? null : severity;
    }
