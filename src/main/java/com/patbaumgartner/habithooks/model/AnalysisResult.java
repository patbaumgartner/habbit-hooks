...
/**
 * The aggregated result of running all configured analyzers against a set of files.
 *
 * @param violations all violations found (may be empty)
 * @param filesChecked number of source files actually analyzed
 */
public record AnalysisResult(List<Violation> violations, int filesChecked) {
