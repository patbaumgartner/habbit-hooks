...
/**
 * A coached violation group: the smell title, optional coaching text, and the list of
 * individual violations that triggered it.
 *
 ...
 * @param coaching optional coaching prompt explaining the smell and how to fix it
 * @param violations the violations belonging to this group
 */
public record CoachingGroup(String ruleId, String title, Optional<String> coaching, List<Violation> violations) {
