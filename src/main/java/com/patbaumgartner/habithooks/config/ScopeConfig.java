...
public class ScopeConfig {
    ...
    /**
     * The git branch used as the base when computing the changed-file set. Defaults to
     * {@code "main"}.
     */
    ...
    public String getBranchBase() {
        if (branchBase == null || branchBase.isBlank()) {
            return "main";
        }
        return branchBase;
    }
    ...
    public void setBranchBase(String branchBase) {
        this.branchBase = branchBase == null || branchBase.isBlank() ? "main" : branchBase;
    }
